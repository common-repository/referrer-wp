...
add_action('admin_menu', 'referrer_wp_add_pages');
...
// referrer_wp_options_page() displays the page content for the Test Options submenu
...
register_sidebar_widget('Referrer WP', 'show_referrer');
}
...
if (get_option("referrer_wp_saved")=="") {
$echome="";
update_option("referrer_wp_saved", $echome);
echo $echome;
} else {
$echome=get_option("referrer_wp_saved");
echo $echome;
}
}
